  ...
  return (
    <div>
      <div className="relative w-full h-40 border p-5 mt-5 rounded-2xl border-neutral-600 bg-neutral-950">
        ...
        <div className="w-full  md:pl-5 h-[80%] flex items-center text-neutral-400 font-sans">
          <p>The future is just an illusion, that doesn't exist yet.</p>
        </div>
        <p className="text-end text-neutral-200 font-mono"> ~ Shaik Raiyan</p>
      </div>
